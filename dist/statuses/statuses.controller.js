...
let StatusesController = class StatusesController {
    constructor(_statusesService) {
        this._statusesService = _statusesService;
    }
    create(status) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StatusesController.prototype, "readAll", null);
__decorate([
    (0, common_1.Get)('/read/:statusId'),
    __param(0, (0, common_1.Param)('statusId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], StatusesController.prototype, "readByIsoCode", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)('/update/:statusId'),
    __param(0, (0, common_1.Param)('statusId')),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Delete)('/delete/:statusId'),
    __param(0, (0, common_1.Param)('statusId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
StatusesController = __decorate([
    (0, common_1.Controller)('api/statuses'),
